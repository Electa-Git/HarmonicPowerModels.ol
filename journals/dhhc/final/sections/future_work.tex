...
\begin{enumerate}
    ...
    \item [c)] network parameters -- Uncertainty on network parameters, e.g., line impedance, can be taken into account using robust programming~\cite{ben-tal_robust_2009}.
...
Although the focus of this paper is on high voltage networks where the system unbalance has negligible effect, the developed model can be extended to unbalanced networks for accurate representation of medium and low voltage distribution grids.
