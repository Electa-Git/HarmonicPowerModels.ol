...
Relevant standards, e.g., IEC61000-2-4:2002~\cite{international_electrotechnical_commission_iec61000-2-4}, specify limits for a.o. individual harmonic voltage distortion, total harmonic voltage distortion, and root-mean-square voltage. Depending on the chosen formulation, these limits are enforced as,
\begin{IEEEeqnarray}{ 0 l } 
...
Relevant standards, e.g., IEC60076-1:2011~\cite{international_electrotechnical_commission_iec60076-1_2011}, specify limits for a.o. root-mean-square current through the edges. Depending on the chosen formulation, these are enforces as, 
\begin{IEEEeqnarray}{ 0 l } 
